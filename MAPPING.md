...
| FR-0-08 / UX-48/49 患者档案 | R2-01/R2-04、`_SPEC/09` 5.3 | 第二批迁移、`departments`、患者模型/接口、`YearMonthInput` | 患者 API 与页面测试 |
| FR-0-09 / UX-50 批量导入 | R2-07/R2-08、UI-R8 | `api/patients.py`、xlsx/csv 解析、`ImportDialog` | 导入逐行结果与完善门禁测试 |
| FR-0-10/11 / UX-53/54 | `_SPEC/04` F006/F018/F019、UI-R1 | 患者最新测量字段、`NumericInput`、预评估/完整评估 | BMI、范围、自动带入测试 |
| FR-0-12 / UX-56 | R2-02/R2-03、UI-R3 | 后端参考字典、`SelectWithOther` / `MultiSelectWithOther` | 字典与表单序列化测试 |
| FR-0-16 / UX-51/52/57/61 | UI-R2/R7/R10 | `DateInput`、病程双框、文案、居中布局、`FooterBar` | 组件测试 + 浏览器走查 |
